...
def QR_code_generator(data,order_id):
    ...
    print("QRCODE ENCRYPTED DATA > ",order_id)
    # generating QR code
    QRcode.make()
    # taking color name from user
    QRcolor = 'black'
    print("QRCODE COLOUR > ",QRcolor)
    ...
    print("QR CODE MADE ,> ", qr_image_name)
    ...
    print("QR IMAGE UPLOADED")
    order = Order.objects.filter(order_id = order_id).first()
    print("QR IMAGE SAVED TO THE DATA BASE")
        ...
        try:
            if transaction and transaction.checkout_request_id:
                ...
                if status == True:
                    ...
                    print("PROCEED TO QR CODE GENERATOR")
                    QR_code_generator(data,order_id)
